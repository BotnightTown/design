...
export default function EndingSection(){
  return(
    <section className="w-full h-max text-white px-40 py-20">
      <div className="w-full h-max p-18 bg-(--second-ground) rounded-[10px] flex flex-row gap-10">
        <div className="w-151 h-96 flex-1">
          <Image
            width={650}
            height={400}
            src={"/cutted.png"}
